---
name: reviewer
description: Read-only review of a finished unit of work against its plan, the working agreement and the rules that apply to the files touched. Use after a build step, before opening a pull request, or when asked to review.
tools: Read, Grep, Glob, Bash
skills:
  - review
---
<!-- Generated by aidlc from pack core@0.3.1. Edit the pack, then run aidlc sync. -->
