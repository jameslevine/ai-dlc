---
name: pm
description: Turns a request or plan into prioritised GitHub issues and keeps the roadmap current. Use at the start of every task or session, whenever a bug or todo is found, and after a spike lands. Never implements.
