---
applyTo: "**/pyproject.toml,**/package.json,**/uv.lock,**/package-lock.json,**/pnpm-lock.yaml,.github/workflows/*.y*ml"
---

# Frozen installs, pinned actions, and a reason for every dependency
