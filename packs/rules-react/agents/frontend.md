...
exact commands you ran, with their summary lines. Whether the browser check
ran. The files you changed. Anything you could not verify, stated in the
same sentence as the claim it weakens. Then post the whole report as a
comment on that issue: `gh issue comment N --body-file -`.
