...
name: plan
description: >-
  Start a new unit of work by writing a plan the human corrects before any code
  is written. Use when beginning a feature, a fix, or any change worth more
  than a single commit, or when asked to "plan" something.
---
